						...
						<div class="row">
							<div class="product-title col-sm-5 col-md-5">
								...
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s">' . sober_svg_icon( 'icon=close-delete-small&size=12&echo=0' ) . '</a>',
