...
/**
 * Class WPBakeryShortCode_Sober_Banner
 */
class WPBakeryShortCode_Sober_Banner extends WPBakeryShortCode {
	/**
	...
	public function getStyles( $el_class, $css, $google_fonts_data, $font_container_data, $atts ) {
		...
		/**
		 * Filter 'VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG' to change sober_banner class
		 *
