	...
	function init_wc_redsys_payment_gateway() {
		...
		class WC_redsys extends WC_Payment_Gateway {
			...
			function receipt_page($order){
				...
				$logActivo=$this->activar_log;
				$this->escribirLog($this->idLog." -- "."Acceso a la página de confirmación de la opción de pago con tarjeta de REDSYS",$logActivo);
			...
			function process_payment($order_id){
				...
				$this->escribirLog($this->idLog." -- "."Acceso a la opción de pago con tarjeta de REDSYS",$logActivo);
