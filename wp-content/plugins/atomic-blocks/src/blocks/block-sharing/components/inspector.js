...
export default class Inspector extends Component {
	render() {
		...
		const buttonStyleOptions = [
			{
				value: 'ab-share-icon-text',
				label: __( 'Icon and Text', 'atomic-blocks' ),
			},
			{
				value: 'ab-share-icon-only',
				label: __( 'Icon Only', 'atomic-blocks' ),
			},
			{
				value: 'ab-share-text-only',
				label: __( 'Text Only', 'atomic-blocks' ),
			},
		];
		...
		const buttonShapeOptions = [
			{
				value: 'ab-share-shape-square',
				label: __( 'Square', 'atomic-blocks' ),
			},
			{
				value: 'ab-share-shape-rounded',
				label: __( 'Rounded Square', 'atomic-blocks' ),
			},
			{
				value: 'ab-share-shape-circular',
				label: __( 'Circular', 'atomic-blocks' ),
			},
		];
		...
		const shareButtonSizeOptions = [
			{
				value: 'ab-share-size-small',
				label: __( 'Small', 'atomic-blocks' ),
			},
			{
				value: 'ab-share-size-medium',
				label: __( 'Medium', 'atomic-blocks' ),
			},
			{
				value: 'ab-share-size-large',
				label: __( 'Large', 'atomic-blocks' ),
			},
		];
		...
		const shareButtonColorOptions = [
			{
				value: 'ab-share-color-standard',
				label: __( 'Standard', 'atomic-blocks' ),
			},
			{
				value: 'ab-share-color-social',
				label: __( 'Social Colors', 'atomic-blocks' ),
			},
		];
		...
		return (
			<InspectorControls key="inspector">
				...
				<PanelBody
					title={ __( 'Sharing Button Options', 'atomic-blocks' ) }
					initialOpen={ false }
				>
